...
public class BookNameIterator implements Iterator{
    Database database;
    ...
    public BookNameIterator(String bookName)throws SQLException{
    ...
    public ResultSet getBooks() throws SQLException {
        return database.get_books_by_name(bookName);
    }
}
